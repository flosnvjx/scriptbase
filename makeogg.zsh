  ...
  if [[ "$1" = ((#b)(cue|gencue|taste|tidy(#B)(|.(#b)(?*)(#B))|lrc|evalpipe:(#b)(?*)(#B)|fifo[.:=](#b)(/?*))(#B)) ]]; then
    ...
    case "$mmode" in
      (tidy|tidy.?*) mmode=tidy
              ...
              ;;
      (evalpipe:?*) mmode=evalpipe; evalpipe=${match[3]} ;;
...
vorbiscmt2cue=(
  ...
  MUSICBRAINZ_ALBUMRELEASECOUNTRY:'d.REM RELEASECOUNTRY'
  ...
  MUSICBRAINZ_RELEASEGROUPID:'d.REM MUSICBRAINZ_RELEASEGROUPID'
  MUSICBRAINZ_ALBUMARTISTID:'d.REM MUSICBRAINZ_ALBUMARTISTID'
...
runencspinsadd=(
  ...
  fdkaac.m3j   -w17000
  fdkaac.m3w   -w20000
  fdkaac.m4    -m4'#128kbps, 15.5kHz'
  fdkaac.m4h   '-m4 -w16120'
  fdkaac.m4i   '-m4 -w17000'
  fdkaac.m4w   "-m4 -w20000"
  fdkaac.m5    -m5'#192kbps'
  fdkaac.m5s   '-m5 -w16120'
  fdkaac.m5r   '-m5 -w17000'
  qaac.cv96    -v96'#16.2/48kHz 15+-.25/44.1kHz'
  qaac.cv112   -v112'#16.5kHz'
  qaac.cv128   -v128"#17+0.5-1kHz"
  ...
  opus.128i   "--bitrate=128 --no-phase-inv"
  opus.144    "--bitrate=144"
  opus.144i   "--bitrate=144 --no-phase-inv"
  opus.160    "--bitrate=160"
  opus.160i   "--bitrate=160 --no-phase-inv"
  aotuv.q3    -q3'#17.2kHz'
  aotuv.q4    -q4'#18.3kHz'
